      ...
      <div className="w-full max-w-4xl mt-8">
        ...
        <ul className="space-y-4">
          <li className="p-4 border-2 rounded-md">
            ...
            <Button className={`mt-2 text-white ${isDarkMode ? "text-black bg-white" : "text-white bg-black"}`}>Apply Now</Button>
          </li>
          <li className="p-4 border-2 rounded-md">
      ...
      <div className="mt-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="flex justify-center">
            <Button type="submit" className={`text-white px-6 py-2 rounded-md ${isDarkMode ? "text-black bg-white" : "text-white bg-black"}`}>
              Submit Application
            </Button>
          </div>
        </form>
